...
async def send_bulk_polls(questions_file):
    ...
    for i, mcq in enumerate(mcqs_list, start=1):  
        ...
        try:  
            ...
            await bot.send_poll(  
                ...
                explanation_parse_mode='MarkdownV2' # Important for formatting
            )  
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        asyncio.run(send_bulk_polls(QUESTIONS_FILE))
    else:
        print("❌ Error: Please provide the questions JSON file as an argument.")
        # Example: python send_polls.py questions.json
